...
class MinifyHTMLHelperTest extends TestCase
{
    ...
    public function test1()
    {
        ...
        if (is_file($utilsFile)) {
            ...
            $output = Minify_mtime([$uri1, $uri2, $obj]);
